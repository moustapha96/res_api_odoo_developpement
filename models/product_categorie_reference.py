...
#         string="Référence Automatique", 
#         compute='_compute_reference_auto',
#         store=True,
#         readonly=True, 
#         copy=False
#     )
#     extracted_model_code = fields.Char(
#         "Code Modèle (déduit)", 
#         compute='_compute_extracted_fields',
#         store=True,
#         readonly=True
#     )
#     extracted_specification = fields.Char(
#         "Spécification (déduite)", 
#         compute='_compute_extracted_fields',
#         store=True,
#         readonly=True
#     )
#     extracted_brand = fields.Char(
#         "Marque (déduite)", 
#         compute='_compute_extracted_fields',
#         store=True,
#         readonly=True
#     )
#     first_tag_code = fields.Char(
#         "Code Premier Tag", 
#         compute='_compute_extracted_fields',
#         store=True,
#         readonly=True
...
#     @api.depends('name', 'categ_id', 'product_tag_ids')
#     def _compute_extracted_fields(self):
#         """Compute all extracted fields when product data changes"""
#         for record in self:
#             # Extract brand
#             record.extracted_brand = self._extract_brand(record.name)
...
#     @api.depends('name', 'categ_id', 'product_tag_ids', 'department_code', 'extracted_brand', 'extracted_model_code', 'extracted_specification', 'first_tag_code')
#     def _compute_reference_auto(self):
#         """Generate automatic reference with uniform notation system"""
#         for record in self:
#             name_part = record.name or ''
...
#         # Pattern 7: Codes courts spécifiques comme "SQC1", "ABC1", etc.
#         pattern_short = r'\b([A-Z]{2,4}\d{1,2})\b'
#         matches_short = re.findall(pattern_short, name_upper)
        
#         # Pattern 8: Codes avec 1 lettre + chiffres comme "U5508", "A1234", etc.
#         pattern_single_letter = r'\b([A-Z]\d{3,5})\b'
#         matches_single_letter = re.findall(pattern_single_letter, name_upper)
...
#         elif matches_short:  # Codes courts comme "SQC1"
#             return matches_short[0]
#         elif matches_single_letter:  # Codes avec 1 lettre comme "U5508"
#             return matches_single_letter[0]
#         elif matches_complex:
#             return matches_complex[0]
#         elif matches_end:
